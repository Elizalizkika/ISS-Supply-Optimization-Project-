...
<body>
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="The code you provided is vulnerable to SQL injection attacks. To fix the code, you should use prepared statements or parameterized queries to prevent malicious input from affecting your database.
